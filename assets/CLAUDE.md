...
- Running tests → Check `aurora/CLAUDE.md` which points to test-specific CLAUDE.md files
- Linting → Check `aurora/CLAUDE.md` for linting commands
...
- When searching online documentation, avoid using project-specific terms like "aurora" as these are internal naming conventions
