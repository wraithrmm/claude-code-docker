...
3. **space** (optional):
   - Confluence space key (default: "Polaris")
   - Use "Polaris" for technical/developer documentation unless specified otherwise
...
- Examples:
  - Feature documentation: `aurora/_lib/[Feature]/README.confluence.md`
  - Build tools: `aurora/_build/[tool]/README.confluence.md`
  - Configuration: `aurora/_config/[system]/README.confluence.md`
...
## Example Reference
See `/workspace/project/aurora/_build/blackfire/README.confluence.md` for a working example of:
...
5. Should this go in a space other than "Polaris"?
