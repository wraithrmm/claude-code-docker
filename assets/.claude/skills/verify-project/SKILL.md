...
## Description
Checks if a project directory contains all the required files for a properly structured PRP. Primarily used internally by other skills like `/continue-project`.
